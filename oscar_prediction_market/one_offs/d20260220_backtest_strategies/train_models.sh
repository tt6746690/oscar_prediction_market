#!/usr/bin/env bash
# Train temporal model snapshots for all categories x model types x snapshot dates.
#
# Each training: CV + feature selection + train + predict
# All with --feature-selection --importance-threshold 0.90 (Phase 3 recommendation).
#
# Usage:
#   cd "$(git rev-parse --show-toplevel)"
#   # 2025 (default):
#   bash oscar_prediction_market/one_offs/d20260220_backtest_strategies/train_models.sh
#   # 2024:
#   bash oscar_prediction_market/one_offs/d20260220_backtest_strategies/train_models.sh 2024
#
# Output: storage/d20260220_backtest_strategies/{YEAR}/models/{category}/{model_short}/{as_of_date}/
...
MODELS_DIR="$EXP_DIR/$CEREMONY_YEAR/models"
...
# LR family uses lr_full features; GBT family uses gbt_full features
MODEL_CONFIGS=(
...
echo "============================================================"
echo "Train Temporal Model Snapshots (Ceremony Year: $CEREMONY_YEAR)"
